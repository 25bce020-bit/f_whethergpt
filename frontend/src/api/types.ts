...
export interface ChatUnderstanding { intent?: string; location?: string | null; time?: string | null; activity?: string | null; language?: string }
export interface Advisory { type: string; severity: string; message: string }
export interface FarmerAdvisory { today_advisory?: string[] }
export interface TravellerAdvisory { suitability?: { status: string; reasons: string[] }; packing?: string[] }
export interface ChatResponse { session_id: string; selected_mode: Mode; active_mode: Mode; display_mode: Mode; message: string; response: string; understanding?: ChatUnderstanding; tool?: ChatTool; location?: Location; weather?: CurrentWeather; forecast?: DailyForecast[]; hourly_forecast?: HourlyForecast[]; historical_weather?: HistoricalDaily[]; climate?: { period: 'last_7_days'; average_temperature_c: number | null }; official_warnings?: Warning[]; advisories?: Advisory[]; recommendations?: string[]; farmer_advisory?: FarmerAdvisory; traveller_advisory?: TravellerAdvisory; [key: string]: unknown }
